    ...
    #     And He will see a rate with the "Skill Level", "L2"
     ...
     Scenario: The role should get added to the order sheet
         Given I have created a rate card with roles
             | Name               | Skill Level |
             | Project Manager    | L1          |
             | Project Manager    | L2          |
             | Software Architect | L1          |
         ...
         And I have created an empty quote with this rate card
         When I visit the quote
         And I select the "Project Manager" resource role
         And I select a rate
         Then I will see the resource role "Project Manager" in the order sheet
