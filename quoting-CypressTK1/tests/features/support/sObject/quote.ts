...
const FIELD_NAME_TIME_PERIODS_ALIGNMENT_USER_DEFINED = 'User Defined Calendar';
...
function getRecordCreateDefaults(isDeployedInPackage = false, { rateCardId, sectionHierarchy }: QuoteRecordInput) {
	...
	quoteSO[qualifier(FIELD_NAME_TIME_PERIODS_ALIGNMENT)] = FIELD_NAME_TIME_PERIODS_ALIGNMENT_USER_DEFINED;
